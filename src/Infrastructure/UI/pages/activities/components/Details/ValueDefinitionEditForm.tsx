...
export const ValueDefinitionEditForm: React.FC<
  ValueDefinitionEditFormProps
> = ({ activityId, definitionId }) => {
  ...
  const state = usePlocState<IValueDefinitionEditFormState>(
    providerValueDefinitionEditFormPloc
  )
  ...
  return (
    <>
      ...
      <Modal
        isOpen={isModalOpen}
        onClose={handleClose}
        title={state.success ? 'Â¡Ã‰xito!' : 'Editar Propiedad'}
      >
        {state.success ? (
          <div className={styles.successContainer}>
            <Text>La propiedad se ha actualizado con Ã©xito.</Text>
