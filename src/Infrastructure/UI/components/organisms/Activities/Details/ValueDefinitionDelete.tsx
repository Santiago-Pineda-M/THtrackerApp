...
export const ValueDefinitionDelete: React.FC<ValueDefinitionDeleteProps> = ({ activityId, definitionId, definitionName }) => {
  ...
  const handleDelete = async () => {
    await providerValueDefinitionDeletePloc.deleteValueDefinition(activityId, definitionId);
  };
  ...
  return (
    <>
      ...
      <Modal
        isOpen={isModalOpen}
        onClose={handleClose}
        title={state.success ? '¡Éxito!' : 'Eliminar Propiedad'}
      >
        {state.success ? (
          ...
          <div className={styles.modalContent}>
            ...
            <Text className={styles.modalText}>
              ¿Estás seguro de que deseas eliminar la propiedad <strong>{definitionName}</strong>?
