...
import type { CreateActivityRequest, ActivityResponse, ApiErrorResponse } from '../../../Domain';
 ...
 */
export class CreateActivityUseCase implements IUseCase<CreateActivityInput, CreateActivityOutput> {
