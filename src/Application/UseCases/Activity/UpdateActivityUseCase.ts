...
import type { UpdateActivityRequest, ActivityResponse, ApiErrorResponse } from '../../../Domain';
 ...
 */
export class UpdateActivityUseCase implements IUseCase<UpdateActivityInput, UpdateActivityOutput> {
