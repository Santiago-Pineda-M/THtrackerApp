...
export class GetListActivityValueDefinitionUseCase implements IUseCase<GetListActivityValueDefinitionInput, GetListActivityValueDefinitionOutput> {
    ...
    async execute(input: GetListActivityValueDefinitionInput): Promise<GetListActivityValueDefinitionOutput> {
        const result = await this.activityValueDefinitionService.getValueDefinitions(input.activityId);
