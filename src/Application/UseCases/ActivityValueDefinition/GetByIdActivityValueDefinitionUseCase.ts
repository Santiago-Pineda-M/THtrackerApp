...
export class GetByIdActivityValueDefinitionUseCase implements IUseCase<GetByIdActivityValueDefinitionInput, GetByIdActivityValueDefinitionOutput> {
    ...
    async execute(input: GetByIdActivityValueDefinitionInput): Promise<GetByIdActivityValueDefinitionOutput> {
        const result = await this.activityValueDefinitionService.getValueDefinitionById(input.activityId, input.id);
