...
import type { UpdateUserProfileRequest, UserProfileResponse, ProblemDetails } from '../../../Domain';
 ...
 * PUT /api/v1/users/me
 */
export class UpdateUserProfileUseCase implements IUseCase<UpdateUserProfileRequest, UpdateUserProfileOutput> {
    ...
    async execute(input: UpdateUserProfileRequest): Promise<UpdateUserProfileOutput> {
    ...
    private isError(result: UserProfileResponse | ProblemDetails): result is ProblemDetails {
