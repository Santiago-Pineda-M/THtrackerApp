...
export class GetActivityLogByIdUseCase implements IUseCase<GetActivityLogByIdRequest, GetActivityLogByIdResult> {
    private readonly activityLogService: IActivityLogService;
    constructor(activityLogService: IActivityLogService) {
        this.activityLogService = activityLogService;
    }

    async execute(request: GetActivityLogByIdRequest): Promise<GetActivityLogByIdResult> {
