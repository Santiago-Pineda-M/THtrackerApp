...
import { type IRefreshTokenState, initialRefreshTokenState } from "../../Domain/IStates";
import type { RefreshTokenUseCases, GetSessionUseCase } from "../../Application/UseCases/Auth";
...
export class RefreshTokenPloc extends Ploc<IRefreshTokenState> {
    ...
    constructor(refreshTokenUseCases: RefreshTokenUseCases, getSessionUseCase: GetSessionUseCase) {
    ...
    async forceRefreshToken(): Promise<void> {
        ...
        try {
            ...
            this.changeState({
                ...
                isRefreshing: false,
                success: false,
                error: error instanceof Error ? error.message : 'Error al refresh el token'
            });
        }
    }
